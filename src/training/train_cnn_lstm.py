...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='configs/cnn_lstm.yaml',
...
def main():
    ...
    if config['dataset'].get('use_grouped_split', False):
        # Persist grouped splits to ensure reproducibility
        save_grouped_splits(
        ...
        # Update train/val split names if custom keys were provided
    ...
    # Evaluate best/final model on test split for bookkeeping
